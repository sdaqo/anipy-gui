...
class AniPyWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, application, *args, **kwargs):
        ...
        self.anime_grid = AnimeView(application=application)
        self.main_stack.add_named(self.anime_grid, "anime_grid")

        self.anime_grid.add_anime_widget(
            AnimeWidget(
                anime=Anime(show_name="Hyoukasssssssssssssssss", category_url="placeholder"), img="some.jpg"
            )
        )
