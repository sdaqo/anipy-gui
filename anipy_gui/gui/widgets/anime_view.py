...
from anipy_gui.gui.widgets.favorites import FavoriteButton
...
class AnimeView(Gtk.Box):
    def __init__(self, application):
        ...
        self.revealer = AnimeRevealer(play_callback=self.anime_play, download_callback=self.anime_download)
    ...
    def on_anime_selected(self, anime: Anime):
        logger.info("Selected anime: {}", anime.show_name)
